...
#include "patch2/iccgrid.hpp"

namespace patch {

iccgrid::iccgrid(double dxw, double dxf, int nsub, int max_size)
    : dx_zaxis_(dxw)
    , dx_radial_(dxf)
    , nsub0_ (nsub)
...
void iccgrid::add_line(std::ostream & a_os, double a_zleft, double a_zright, double a_radius, double a_deps, int a_z_min, bool is_internal) 
{
    a_os << "Cylinder tiles:\n";
...
void iccgrid::add_arc(std::ostream & a_os, double za0, double ra0, double ra, double ta1, double ta2, double a_deps, int a_z_min, bool is_outer) 
{
...
void iccgrid::add_wall(std::ostream & a_os, double a_z, double a_rl1, double a_rl2, double a_deps, int min_phi, int min_rad, bool is_to_positive) 
{
    a_os << "Wall tiles:\n";
...
void iccgrid::generate_matrix(int file_id, boost::multi_array< double, 2 > & a_matrix) 
{
