#ifndef IONCH_EVALUATOR_OBJECT_OVERLAP_HPP
#define IONCH_EVALUATOR_OBJECT_OVERLAP_HPP
...
class object_overlap : public base_evaluator
 {
   public:
    virtual ~object_overlap() {}
  ...
  friend class boost::serialization::access;
   ...
   public:
    ...
    {
      return object_overlap::type_label_();
    }
